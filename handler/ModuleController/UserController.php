...
if (isset($_POST['updateprofileimage'])) {
  ...
  if ($CheckifPhone != null) {;
    ...
    $Save = SAVE("users", ["UserFullName", "UserType", "UserDateOfBirth", "UserSalutation", "UserPassword", "UserPhoneNumber", "UserEmailId", "UserCompanyName", "UserWorkFeilds", "UserDepartment", "UserDesignation", "UserNotes", "UserStatus", "UserCreatedAt"]);
  }
