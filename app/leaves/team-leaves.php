                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="card card-body rounded-3 p-4">
                                                        <div class="flex-s-b">
                                                            <h4 class="count mb-0 m-t-5 text-primary">
                                                                <?php echo TOTAL("SELECT UserLeaveId FROM user_leaves, user_employment_details where user_leaves.UserMainId=user_employment_details.UserMainUserId and user_employment_details.UserEmpReportingMember='" . LOGIN_UserId . "'"); ?>
                                                            </h4>
                                                        </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="card card-body rounded-3 p-4">
                                                        <div class="flex-s-b">
                                                            <h4 class="count mb-0 m-t-5 text-primary">
                                                                <?php echo TOTAL("SELECT UserLeaveId FROM user_leaves, user_employment_details where UserLeaveStatus='NEW' and user_leaves.UserMainId=user_employment_details.UserMainUserId and user_employment_details.UserEmpReportingMember='" . LOGIN_UserId . "'"); ?>
                                                            </h4>
                                                        </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="card card-body rounded-3 p-4">
                                                        <div class="flex-s-b">
                                                            <h4 class="count mb-0 m-t-5 text-primary">
                                                                <?php echo TOTAL("SELECT UserLeaveId FROM user_leaves, user_employment_details where UserLeaveStatus='APPROVED' and user_leaves.UserMainId=user_employment_details.UserMainUserId and user_employment_details.UserEmpReportingMember='" . LOGIN_UserId . "'"); ?>
                                                            </h4>
                                                        </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="card card-body rounded-3 p-4">
                                                        <div class="flex-s-b">
                                                            <h4 class="count mb-0 m-t-5 text-primary">
                                                                <?php echo TOTAL("SELECT UserLeaveId FROM user_leaves, user_employment_details where UserLeaveStatus='REJECTED' and user_leaves.UserMainId=user_employment_details.UserMainUserId and user_employment_details.UserEmpReportingMember='" . LOGIN_UserId . "'"); ?>
                                                            </h4>
                                                        </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="card card-body rounded-3 p-4">
                                                        <div class="flex-s-b">
                                                            <h4 class="count mb-0 m-t-5 text-primary">
                                                                <?php echo TOTAL("SELECT UserLeaveId FROM user_leaves, user_employment_details where UserLeaveStatus='APPROVED' AND user_leaves.UserMainId=user_employment_details.UserMainUserId and user_employment_details.UserEmpReportingMember='" . LOGIN_UserId . "' and DATE(UserLeaveFromDate)='" . date('Y-m-d') . "'"); ?>
                                                            </h4>
                                                        </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="card card-body rounded-3 p-4">
                                                        <div class="flex-s-b">
                                                            <h4 class="count mb-0 m-t-5 text-primary">
                                                                <?php echo TOTAL("SELECT UserLeaveId FROM user_leaves, user_employment_details where user_leaves.UserMainId=user_employment_details.UserMainUserId and user_employment_details.UserEmpReportingMember='" . LOGIN_UserId . "' and UserLeaveStatus='APPROVED' AND DATE(UserLeaveFromDate)>='" . date('Y-m-d') . "'"); ?>
                                                            </h4>
                                                        </div>
                                                ...
                                                <div class='col-md-12'>
                                                    ...
                                                    $ALLData = _DB_COMMAND_("SELECT * FROM user_leaves, user_employment_details where user_leaves.UserMainId=user_employment_details.UserMainUserId and user_employment_details.UserEmpReportingMember='" . LOGIN_UserId . "' ORDER by DATE(UserLeaveFromDate) DESC", true);
                                                    if ($ALLData != null) {
                                                        $SerialNo = SERIAL_NO;
