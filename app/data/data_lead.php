...
include "sections/dataleadHeader.php";
                            ...
                            <div class="card card-primary">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-12">
                                            <a href="data_lead.php" class="flex-s-b btn btn-sm btn-primary btn-block">
                                                <span class="">
                                                    All Data Lead
                                                </span>
                                    ...
                                    ?>
                                        <div class="row">
                                            <div class="col-md-12 mb-2 shadow-sm p-2">
                                                ...
                                                <a href="data_lead.php" class="btn btn-xs btn-danger fs-11 pull-right" style="margin-top:-5.3em !important;">Clear Filter <i class="fa fa-times"></i></a>
                                            </div>
                                        </div>
                                    <?php }
                                    ?>
