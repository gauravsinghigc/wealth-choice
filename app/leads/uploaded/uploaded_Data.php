                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <a href="index.php" class="flex-s-b btn btn-sm btn-default btn-block">
                        <span class="fs-15">All Uploaded Leads</span>
                      </a>
                    </div>
                    <div class="col-md-6">
                      <a href="uploaded_Data.php" class="flex-s-b btn btn-sm btn-primary btn-block">
                  ...
                  <div class="row mt-4">
                    <div class="col-md-12">
                      <h4 class="app-heading fs-15"><?php echo $PageName; ?>
                        <a href="transfer_Data.php" class='btn btn-sm btn-danger pull-right'><i class='fa fa-exchange'></i> Transfer Fresh Data</a>
                      </h4>
                    </div>
                    <div class="col-md-10">
                      <div class="btn-group btn-group-md">
                        ...
                        <a href="index.php?all_leads=true" class="btn btn-xs btn-default">All Transffered Data <span class="bg-success p-1 rounded fs-11"><?php echo $sent = TOTAL("SELECT * FROM data_lead_uploads where DataStatus='TRANSFERRED'"); ?></span></a>
                        <a href="index.php" class="btn btn-xs btn-default">All Uploaded Data <span class="bg-primary p-1 rounded fs-11"><?php echo $All = TOTAL("SELECT * FROM data_lead_uploads"); ?></span></a>
                        <a href="index.php?view=TRANSFERRED" class="btn btn-xs btn-default">All Transffered Data <span class="bg-success p-1 rounded fs-11"><?php echo $sent = TOTAL("SELECT * FROM data_lead_uploads where DataStatus='TRANSFERRED'"); ?></span></a>
                    ...
                    <div class="col-md-12">
                      ...
                      if (LOGIN_UserType == "Digital" || LOGIN_UserType == "Admin") {
                        if (isset($_GET['UploadedOn'])) {
                          $UploadedOn = $_GET['UploadedOn'];
                          $TotalItems = TOTAL("SELECT DataUploadId FROM data_lead_uploads where DataStatus='$view' and DATE(UploadedOn)='$UploadedOn'");
                        } else {
                          $UploadedOn = '';
                          $TotalItems = TOTAL("SELECT DataUploadId FROM data_lead_uploads where DataStatus='$view'");
                        }
                      } elseif (isset($_GET['all_leads'])) {
                        $TotalItems = TOTAL("SELECT DataUploadId FROM data_lead_uploads", true);
                      } else {
                        if (isset($_GET['UploadedOn'])) {
                          $UploadedOn = $_GET['UploadedOn'];
                          $TotalItems = TOTAL("SELECT DataUploadId FROM data_lead_uploads where DataStatus='$view' and DATE(UploadedOn)='$UploadedOn'");
                      ...
                      if (LOGIN_UserType == "Digital") {
                        if (isset($_GET['UploadedOn'])) {
                          $UploadedOn = $_GET['UploadedOn'];
                          $Leads = _DB_COMMAND_("SELECT * FROM data_lead_uploads where DataStatus='$view' and DATE(UploadedOn)='$UploadedOn' limit $start, $listcounts", true);
                        } else {
                          $UploadedOn = '';
                          $Leads = _DB_COMMAND_("SELECT * FROM data_lead_uploads where DataStatus='$view' limit $start, $listcounts", true);
                        }
                      } elseif (isset($_GET['all_leads'])) {
                        $Leads = _DB_COMMAND_("SELECT * FROM data_lead_uploads limit $start, $listcounts", true);
                      } else {
                        if (isset($_GET['UploadedOn'])) {
                          $UploadedOn = $_GET['UploadedOn'];
                          $Leads = _DB_COMMAND_("SELECT * FROM data_lead_uploads where DataStatus='$view' and DATE(UploadedOn)='$UploadedOn' limit $start, $listcounts", true);
                        ...
                        foreach ($Leads as $Data) {
                          ...
                          <p class="data-list flex-s-b">
                            <span>
                              ...
                              for <span class='text-warning'><?php echo FETCH("SELECT * FROM projects where ProjectsId='" . $Data->DataProjectsRef . "'", "ProjectName"); ?></span>
                              ...
                              <span class="bold">
                                <?php echo FETCH("SELECT * FROM users where UserId='" . $Data->DataUploadBy . "'", "UserFullName"); ?>
                              </span>
                              <span class="text-grey">
                                Uploaded For :
                              </span>
                            ...
                            <span>
                              <span class='text-info'><?php echo LeadStatus($Data->DataStatus); ?></span>
                            </span>
                          </p>
                      <?php }
                      } ?>
