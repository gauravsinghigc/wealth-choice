                            ...
                            <div class="card card-primary">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <a href="Upload_Data.php" class="flex-s-b btn btn-sm btn-primary btn-block">
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-8">
                                            <h5 class="app-sub-heading">Upload Data</h5>
                                            <form class="row" action="<?php echo CONTROLLER; ?>" enctype="multipart/form-data" method="POST">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select name="LeadType" class="form-control" required>
                                                        <?php echo InputOptions(['DATA'], 'DATA'); ?>
                                                    </select>
                                                </div>
                                                <div class="col-md-12">
                                                    <a href="../uploaded/uploaded_Data.php" class="btn btn-md btn-default m-t-15"><i class="fa fa-angle-left"></i> View Uploaded Data</a>
                                                    <button type="submit" name="UploadData" class="btn btn-md btn-dark"><i class="fa fa-upload"></i> Upload Data</button>
                                                </div>
                                            </form>
                                        </div>
