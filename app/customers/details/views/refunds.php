 <div class="card card-body p-2">
   <h4 class="app-heading">All Refunds</h4>
           ...
           <li class="data-list">
             <p class="flex-s-b">
               ...
               <span class='w-pr-17 text-right p-1'>
                 <a href="<?php echo APP_URL; ?>/crm/reg/details/?bid=<?php echo SECURE($Data->bookingId, "e"); ?>" class='btn btn-xs btn-default'><i class='fa fa-file text-danger'></i> View Details</a>
               </span>
             </p>
           </li>
       <?php
