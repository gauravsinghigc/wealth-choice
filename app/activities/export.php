...
<head>
  ...
  <?php require $Dir . '/assets/HeaderFiles.php'; ?>
  <style>
...
<body onload="window.print()">
  ...
  <div class="printable-area m-t-3" style="box-shadow:0px 0px 2px grey !important;">
    <?php
    include $Dir . '/include/export/export-header.php';
    GENERATE_APP_LOGS("EXPORT", "ALL Activities Exported @ RefID: $ExportRefid", "EXPORT"); ?>
    ...
    <?php include $Dir . '/include/export/export-footer.php'; ?>
  </div>


  <?php
  require $Dir . '/assets/FooterFiles.php';
  ?>
</body>
