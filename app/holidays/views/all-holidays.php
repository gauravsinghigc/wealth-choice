<div class="card-body">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="calendar">
                ...
                $Calendar = "<div>
                        ...
                        ";
                $Calendar .=  InputOptionsWithKey($AllMonths, IfRequested('GET', 'month', $nextMonth - 1, false));
                $Calendar .= "
                        </select>
        ...
        <div class='col-md-6'>
            <h4 class='app-sub-heading' style='font-size:1.3rem !important;'>All Holidays for :
                <?php echo date("M, Y", strtotime($ViewData)); ?>
            </h4>
            <div class='row'>
                <?php
                ...
                ?>
                        <div class='col-md-12'>
                            <div class="data-list flex-s-b">
                                ...
                                <div class="w-pr-75">
                                    <div class="p-1">
                                        <h5 class="bold"><?php echo $Holiday->ConfigHolidayName; ?></h5>
                                        <p class="text-secondary"><?php echo SECURE($Holiday->ConfigHolidayNotes, "d"); ?></p>
                                    </div>
                                </div>
                                <div class="w-pr-25 p-3">
                                    <a href="#" onclick="Databar('Update_Holiday_<?php echo $Holiday->ConfigHolidayid; ?>')" class='btn btn-xs btn-primary'><i class='fa fa-edit'></i> Update</a>
                                </div>
                            </div>
                        </div>
                <?php
                        include  $Dir . "/include/forms/Update-Holiday-Details.php";
                    }
                }
                ?>
            </div>
