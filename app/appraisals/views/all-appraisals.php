 <div class="card-body">
     ...
     <div class="row">
         <div class="col-md-3 col-sm-6 col-6">
             <div class="card p-2">
                 <h1><?php echo TOTAL("SELECT * FROM user_appraisals"); ?></h1>
         ...
         <div class="col-md-3 col-sm-6 col-6">
             <div class="card p-2">
                 <h1>
                     <?php echo TOTAL("SELECT * FROM user_appraisals where DATE(UserAppraisalDate)='" . date('Y-m-d') . "'"); ?>
                 </h1>
         ...
         <div class="col-md-3 col-sm-6 col-6">
             <div class="card p-2">
                 <h1>
                     <?php echo TOTAL("SELECT * FROM user_appraisals where YEAR(UserAppraisalDate)='" . date('Y') . "' and MONTH(UserAppraisalDate)='" . date('m') . "'"); ?>
                 </h1>
         ...
         <div class="col-md-3 col-sm-6 col-6">
             <div class="card p-2">
                 <h1>
                     <?php echo TOTAL("SELECT * FROM user_appraisals where YEAR(UserAppraisalDate)='" . date('Y') . "'"); ?>
                 </h1>
